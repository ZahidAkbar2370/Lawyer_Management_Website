...
<div class="row-fluid sortable">		
				<div class="box span12">
					<a href="{{URL::to('add-client')}}"><button>Add Client</button></a>
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>All Client</h2>
					</div>
								...
								@foreach($data as $key=> $value)
								 <tbody>
									<tr>
										...
										<td class="center"><?php echo $value->client_name; ?></td>
										...
										<td class="center">
											...
											@endif
											<a class="btn btn-info" href="{{URL::to('edit_client/'.$value->id)}}">
												<i class="halflings-icon white edit"></i>  
											</a>
											<a class="btn btn-danger" href="delete_client/{{$value->id}}">
